...
function init_mpu6050_slider()
    --初始化
    --{
    slider_mpu6050 = lvgl.slider_create(lvgl.scr_act(), nil)    ---创建滑动条
    lvgl.obj_set_size(slider_mpu6050, 128, 5)            -- 设置尺寸
    lvgl.obj_align(slider_mpu6050, nil, lvgl.ALIGN_CENTER, 0, 0)--设置居中
    --}
    ...
    lvgl.slider_set_range(slider_mpu6050, range_slider_min, range_slider_max)         --设置范围，默认0-100
    lvgl.slider_set_value(slider_mpu6050, 0, lvgl.ANIM_OFF)

    log.info("scr_load",lvgl.scr_load(slider_mpu6050))     --显示

    -- lvgl.slider_set_value(slider_mpu6050, 67, lvgl.ANIM_OFF)

    log.info("lvgl demo: slider_mpu6050")
    return slider_mpu6050
end
