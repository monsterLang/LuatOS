...
function init_mpu6050_cont()
    ...
    lvgl.obj_align_origo(mpu6050_cont, nil, lvgl.ALIGN_CENTER, 0, 0)  --This parametrs will be sued when realigned*/
    ...
    -- --创建标签label
    -- local label = lvgl.label_create(mpu6050_cont, nil)
    ...
    -- label = lvgl.label_create(mpu6050_cont, nil)
