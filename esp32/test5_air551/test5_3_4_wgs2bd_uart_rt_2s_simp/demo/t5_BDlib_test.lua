...
function lib_draw_line()
    print("enter lib_draw_line ---------------")
    print("LCD_list_temp_num",LCD_list_temp_num,"xy_list_BD_num_max",xy_list_BD_num_max)
    ...
    if LCD_list_temp_num > 1 then
        ...
        if LCD_list_temp_num < LCD_list_temp_num_max   then
            ...
            -- log.info("lcd.drawLine", lcd.drawLine(1,72,1,90,0x001F))
            -- log.info("lcd.drawLine", lcd.drawLine(79,72,74,72,0x001F))
            -- log.info("lcd.drawLine", lcd.drawLine(50,72,79,72,0x001F))
            -- print(2*LCD_list_temp_num-3,2*LCD_list_temp_num-2,2*LCD_list_temp_num-1,2*LCD_list_temp_num)
    ...
    print("exit lib_draw_line ---------------")

end

function lib_draw_circle()
...
--         print("before draw str")
--         lcd.drawStr(0,155,m_lcd)
--         print("after draw str")
--     end
