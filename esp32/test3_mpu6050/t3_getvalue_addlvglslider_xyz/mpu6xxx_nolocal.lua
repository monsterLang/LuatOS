...
-- 2. gsensor: mpu6050
-- function init_mpu6050_i2s()
--     log.info("start init_mpu6050")
--     addr_mpu6050 = 0x68
--     i2c_mpu6050 = 0 -- esp32c3支持0，s3支持0/1

--     if i2c.setup(i2c_mpu6050, i2c.FAST, addr_mpu6050) == 1 then
--         log.info("i2c", "存在 i2c0")
--     else
--         i2c.close(0) -- 除非i2c的id错误,通常不会失败
--         return
--     end
--     log.info("end init_mpu6050")
-- end

-- function mpu6050_get_value ()
--     i2c.send(i2c_mpu6050, addr_mpu6050, string.char(0x75))--发送器件地址
--     sys.wait(50)
--     local revData = i2c.recv(i2c_mpu6050, addr_mpu6050, 1)--读器件地址
