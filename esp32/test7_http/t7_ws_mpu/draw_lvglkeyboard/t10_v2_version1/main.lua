...
sys.taskInit(
    function ()
        ...
        if T2_WS == 1 then
            init_wifi()
            local status_ws = ws_connect()
            if status_ws == true then
                view_list.v2_ta_value = "connect websocket"
        ...
        -- func3: key input
        if T4_key_input == 1 then
            key_init(13)       -- io13作为输入
        end
        ...
        while true do
            ...
            if T4_key_input == 1 then
                ...
                local temp_key_value = judge_key()
                if temp_key_value == 1 then
                    key_press()
                end
                -- sys.wait(500)
            end
