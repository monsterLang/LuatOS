...
function kb_focused_btn(num)
    local temp_kb_num = num
    if temp_kb_num < 0 then
        temp_kb_num = 13
    elseif temp_kb_num > 13 then
        temp_kb_num = 0
    end

    lvgl.btnmatrix_set_focused_btn(btnm_kb, num)
end

function kb_choose_up( num )
    local temp_kb_num = num
    if temp_kb_num < 0 then
        temp_kb_num = 13
    elseif temp_kb_num > 13 then
    ...
    -- lvgl.btnmatrix_set_one_check(btnm_kb, temp_kb_num)
    ...
    -- lvgl.btnmatrix_set_btn_ctrl(btnm_kb, temp_kb_num, lvgl.KEY_ENTER)

    -- 清除切换状态
    lvgl.btnmatrix_clear_btn_ctrl(btnm_kb, temp_kb_num, lvgl.BTNMATRIX_CTRL_CHECK_STATE)
end

function kb_choose_down( num )
    local temp_kb_num = num
    if temp_kb_num < 0 then
        temp_kb_num = 13
    elseif temp_kb_num > 13 then
    ...
    -- 设置切换状态
    lvgl.btnmatrix_set_btn_ctrl(btnm_kb, temp_kb_num, lvgl.BTNMATRIX_CTRL_CHECK_STATE)
