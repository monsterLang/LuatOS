...
function kb_choose_up()
    ...
    --     lvgl.btnmatrix_set_focused_btn(view_list.v2_keyboard, view_list.v2_9btn_num)
    ...
    -- elseif view_list.v2_kb_choosed == 0 then
    --     print("choose 9 key")


    --     view_list.v2_9btn_num = view_list.v2_focus
    --     print("save",view_list.v2_9btn_num)
        

    --     if view_list.v2_focus < 0 then
    --         view_list.v2_focus = 13
    --     elseif view_list.v2_focus > 13 then
    --         view_list.v2_focus = 0
    --     end
    ...
    -- lvgl.btnmatrix_set_one_check(view_list.v2_keyboard, view_list.v2_focus)
    ...
    -- lvgl.btnmatrix_set_btn_ctrl(view_list.v2_keyboard, view_list.v2_focus, lvgl.KEY_ENTER)
    -- 设置切换状态
